...
export const NAME = 'Fuyu Ooumi';
export const HEADER_NAME = 'Fuyu Ooumi';
export const FIRST_NAME = 'Fuyu';
...
// Contact Info
export const SKYPE_ADDRESS = 'https://join.skype.com/invite/t3vb6yjMvoK3';
export const GITHUB_ADDRESS = 'https://github.com/fuyuooumi1027';
export const GMAIL_ADDRESS = 'mailTo:fuyuooumi1027@gmail.com';
export const CHATWORK_ADDRESS = 'https://www.chatwork.com/14zkvvsxbvpf';
export const SLACK_ADDRESS = 'https://join.slack.com/t/fuyusworkspace/shared_invite/zt-27g2ipoxj-J3PecboJxZwOZyVhRjO4Zw';
