    ...
    <div className="row container about_section">
      <div className="columns" data-aos="fade-right" data-aos-delay="300">
        ...
        <h4>
          <FormattedMessage
            id="descriptions"
            defaultMessage="お世話になっております。"
          />
        </h4>
        <p>私はソフトウェア エンジニアリングで 10 年以上の経験を持つ、熱心なシニア フルスタック エンジニアです。</p>
        <p>常に挑戦を愛し、目標を達成するために一生懸命働く。 複数のプログラミング言語、フレームワークに関する高度な知識があり、いくつかのデータベース構造に精通している。</p>
        <p>技術的なスキルに加えて、デザインとユーザー エクスペリエンスにも鋭い目を向けており、ユーザーが何度も戻ってきてしまう直感的で魅力的なインターフェイスを作成することができます。 私はキャリアを通じて、ネイティブ開発とクロスプラットフォーム開発の両方に携わってきました。 批判的思考、細心の注意、そして最新のテクノロジーを常に最新の状態に保つことへの私の献身により、私は現在の役割で上級フルスタック開発者の地位に昇進することができました。</p>
        <p>シニア開発者、リード開発者として働いている私は、多数のユーザー向けにいくつかの成功したウェブサイト、モバイルアプリ、DeFi プラットフォームを構築し、クライアントのビジネスアイデアに応じてさまざまな技術分野に関わるいくつかのプロジェクトを成功させてきました。</p>
        ...
        <div className="mas-info">
          ...
          >
            <FormattedMessage id="btn-cv" defaultMessage="履歴書をダウンロード" />
          </a>
