    ...
    <section className="proyectos" id="proyectos">
      ...
      >
        ...
        >
          ...
          <SwiperSlide className="caja">
            <img src={proyectImg(`./project12.png`)} alt="proyectos" />
          </SwiperSlide>

          <SwiperSlide className="caja">
            <img src={proyectImg(`./project13.png`)} alt="proyectos" />
          </SwiperSlide>

          <SwiperSlide className="caja">
            <img src={proyectImg(`./project14.png`)} alt="proyectos" />
          </SwiperSlide>

          <SwiperSlide className="caja">
            <img src={proyectImg(`./project15.png`)} alt="proyectos" />
          </SwiperSlide>

          <SwiperSlide className="caja">
            <img src={proyectImg(`./project16.png`)} alt="proyectos" />
          </SwiperSlide>

          <SwiperSlide className="caja">
            <img src={proyectImg(`./project17.png`)} alt="proyectos" />
          </SwiperSlide>

          <SwiperSlide className="caja">
            <img src={proyectImg(`./project18.png`)} alt="proyectos" />
          </SwiperSlide>

          <SwiperSlide className="caja">
            <img src={proyectImg(`./project19.png`)} alt="proyectos" />
          </SwiperSlide>

          <SwiperSlide className="caja">
            <img src={proyectImg(`./project20.png`)} alt="proyectos" />
          </SwiperSlide>
