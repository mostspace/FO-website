          ...
          <div className="row">
            <div className="columns" data-aos="fade-up" data-aos-delay="200">
              ...
              <p>
                <FormattedMessage
                  id="design-info"
                  defaultMessage="ユーザーを魅了し、ブランドの本質を反映する素晴らしいデザインを作成します。 アイデアを視覚的に魅力的でユーザーフレンドリーなデザインに変換します。 オンラインでのプレゼンスを実現しましょう!"
                />
              </p>
            </div>
            <div className="columns" data-aos="fade-up" data-aos-delay="300">
              ...
              <h3>
                <FormattedMessage
                  id="development"
                  defaultMessage="WEB開発"
                />
              </h3>
              <p>
                <FormattedMessage
                  id="development-info"
                  defaultMessage="お客様のニーズに合わせたプロフェッショナルな Web 開発サービス。 私たちは、パフォーマンスを最適化し、シームレスな機能を確保しながら、見た目が美しくユーザーフレンドリーな Web サイトを作成します。"
                />
              </p>
            </div>
            <div className="columns" data-aos="fade-up" data-aos-delay="400">
              ...
              <p>
                <FormattedMessage
                  id="marketing-info"
                  defaultMessage="当社の Web マーケティング サービスを使用して、オンライン プレゼンスの可能性を最大限に引き出します。 戦略的な SEO やターゲットを絞ったキャンペーンから魅力的なコンテンツ作成まで、トラフィックを促進し、コンバージョンを促進し、デジタル環境におけるブランドの認知度を高めます。"
                />
              </p>
            </div>
            <div className="columns" data-aos="fade-up" data-aos-delay="500">
              ...
              <p>
                <FormattedMessage
                  id="maintenance-info"
                  defaultMessage="あなたのアイデアを革新的なモバイル アプリケーションに変換します。 当社のアプリ開発サービスは、プラットフォーム全体で直感的で機能豊富なソリューションを提供し、ユーザーを魅了し、ビジネスの成長を促進します。"
                />
              </p>
            </div>
            <div className="columns" data-aos="fade-up" data-aos-delay="600">
              ...
              <h3>
                <FormattedMessage
                  id="seod"
                  defaultMessage="セキュリティ"
                />
              </h3>
              <p>
                <FormattedMessage
                  id="seo-infodd"
                  defaultMessage="当社の堅牢な Web セキュリティ サービスでオンライン資産を保護します。 当社は、脆弱性を特定し、サイバー脅威から保護し、データプライバシーを確保するための包括的なソリューションを提供します。 お客様のデジタル プレゼンスを強化し、安心感を提供する当社を信頼してください。"
                />
              </p>
            </div>
            <div className="columns" data-aos="fade-up" data-aos-delay="700">
              ...
              <p>
                <FormattedMessage
                  ...
                  defaultMessage="包括的な Web サポート サービスにより、スムーズで手間のかからない Web サイト運営を保証します。 定期的なメンテナンスからタイムリーな更新、信頼性の高いトラブルシューティングまで、当社はお客様の Web サイトを完璧に稼働させ、お客様が本来の業務に集中できるようにします。"
                />
              </p>
            </div>
          </div>
